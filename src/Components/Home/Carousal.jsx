            ...
            <div className="container  mt-3">
                <div className="row ">
                    <div className="col-md-12">
                        <img className="img-fluid" src="https://images.pexels.com/photos/7210754/pexels-photo-7210754.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" loading='lazy' alt="" />
                    </div>
                </div>
            </div>
        </>
