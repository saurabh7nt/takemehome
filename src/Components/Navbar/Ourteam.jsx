        ...
        <div className="row">
          <div className="col-md-4 ">
            <div class="col">
              <div class="card image-container">
                <img src={process.env.PUBLIC_URL + '/Images/team55.jpg'} class="card-img-top pop-up-image" alt="..." />
                <div class="card-body">
                  <h5 class="card-title">Dr. Kunal Darekar</h5>
          ...
          <div className="col-md-8">
            <div class="row row-cols-1 row-cols-md-2 g-4 ">
              <div class="col">
                <div class="card image-container">
                  <img src={process.env.PUBLIC_URL + '/Images/team11.jpg'} class="card-img-top pop-up-image" alt="..." />
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card image-container">
                  <img src={process.env.PUBLIC_URL + '/Images/team22.jpg'} class="card-img-top pop-up-image" alt="..." />
                  <div class="card-body">
                    <h5 class="card-title">Dr. Pavan Darve</h5>
                    <h6 class="text-body-secondary">Veterinary Consultant</h6>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="card image-container">
                  <img src={process.env.PUBLIC_URL + '/Images/team33.jpg'} class="card-img-top pop-up-image" alt="..." />
                  <div class="card-body">
                    <h5 class="card-title">Dr. Ashlesh Bike</h5>
              ...
              <div class="col">
                <div class="card image-container">
                  <img src={process.env.PUBLIC_URL + '/Images/team44.jpg'} class="card-img-top pop-up-image" alt="..." />
                  <div class="card-body">
